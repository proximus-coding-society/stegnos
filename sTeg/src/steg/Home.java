       ...
       if (returnVal == JFileChooser.APPROVE_OPTION){
				...
				try{
					...
					//display the new image
                                       ...
                                       //JLabel background = new JLabel(new ImageIcon(ImageIO.read(new File(path + "/" + stegan + ".png"))));
                                       //imgpanel.add(background);
					
                                        JDialog dialog = new JDialog();     
                                        dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
                                        dialog.setTitle("Image Loading Demo");

                                        dialog.add(new JLabel(new ImageIcon(ImageIO.read(new File(path + "/" + stegan + ".png")))));
